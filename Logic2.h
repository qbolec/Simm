...
struct OnEachBlocksSequence{
  ...
  OnEachBlocksSequence(TextInfo &a,TextInfo &b):a(a),b(b),bestMatching(a.important_text.length(),b.important_text.length()),bestCost(1e9),testedSequences(0),validBrackets(0){
  }
